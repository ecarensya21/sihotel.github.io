...
use App\Models\SuperiorModel;
use App\Controllers\BaseController;


class DataSuperior extends BaseController
{
    protected $pengajuan;
    public function __construct()
    {
        $this->pengajuan = new SuperiorModel();
    }
    public function index()
    {
        ...
        $data['title'] = 'Data Transaksi Superior |Bintang Flores Hotel';
        $data['datapesan'] = $joindata;
        // dd($data);
        return view('/admin/data_superior', $data);
    }
    public function delete($id)
    {
        $berhasil = $this->pengajuan->delete($id);
        if ($berhasil) {
            return redirect()->to('/data-superior')->with('success', 'Hapus Data Pemesanan Berhasil');
        }
    }
    public function detail($userId)
    {
        ...
        return view('/admin/detail_superior', $data);
        // dd($data);
    }
