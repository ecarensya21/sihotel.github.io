...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active">Transaksi Deluxe</li>
    </ol>
                    ...
                    <tbody class="table-group-divider">
                        ...
                        foreach ($datapesan as $row) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= site_url('/data-transaksi-deluxe/' . $row['id']); ?>" title="Detail" class="btn btn-warning btn-sm my-2"><i class="fa-solid fa-pen-to-square"></i> Detail</a>
                                    <!-- ==========================Method Spoofing====================== -->
