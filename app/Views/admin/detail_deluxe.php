...
<div class="container-fluid px-4">
    <h1 class="mt-4">Transaksi deluxe</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="<?= base_url('/dashboard-admin'); ?>">Dashboard</a></li>
        <li class="breadcrumb-item "><a href="<?= base_url('/data-transaksi-deluxe'); ?>">Transaksi deluxe</a></li>
        <li class="breadcrumb-item active">Detail Data deluxe</li>
    </ol>
                    ...
                    <?php if (!empty($detail)) : ?>
                        ...
                        <div class="row m-5">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <b class="d-inline text-danger"><?= $item['status'] ?></b>
                            </div>
                            <div class="col-md-4 mb-3">
            ...
            <div class="tabeldata">
                <table class="table table-bordered table-responsive">
                    ...
                    <tbody class="table-group-divider">
                        ...
                        <tr>
                            <td>
                                <p><b class="text-danger"><?= $item['status']; ?></b></p>
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                <?php elseif ($item['status'] == 'Konfirmasi') : ?>
                                ...
                                <?php elseif ($item['status'] == 'Pembayaran') : ?>
                                ...
                                <?php elseif ($item['status'] == 'Kamar Habis') : ?>
                                    <!-- ================================================================== -->
                                    <a class="btn btn-sm btn-dark mb-3 d-block disabled" href="<?= base_url('/data-transaksi-reguler/status/' . $item['id'] . '/Selesai'); ?>">
                                        <i class="fa-solid fa-flag"></i> Selesai
                                    </a>
