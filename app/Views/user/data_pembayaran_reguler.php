...
<div class="container">
    <div class="section-header-form">
        <h2>Form Pemesanan Reguler Room</h2>
        <hr>
    </div>
    ...
    <div class="card shadow-lg border-0 rounded-lg mb-5">
        <div class="card-body">
            ...
            <div class="row g-3 m-5">
                <div class="col-md-8">
                    <img src="<?= base_url('assets/img/reguler_room.jpg'); ?>" alt="" width="520px" height="250px">
                </div>
                <div class="col-md-4 mb-5">
                    <h3>Room Description</h3>
                    <h4 class="text-primary">IDR 350.000</h4>
            ...
            <form class="row g-3 m-5" action="<?= base_url('/detail/reguler-room/form-booking/save'); ?>" method="post">
                <?= csrf_field(); ?>
