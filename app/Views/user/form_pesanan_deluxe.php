...
<div class="container">
    <div class="section-header-form">
        <h2>Form Pemesanan Deluxe Room</h2>
        <hr>
    </div>
    ...
    <div class="card shadow-lg border-0 rounded-lg mb-5">
        <div class="card-body">
            ...
            <div class="row g-3 m-5">
                <div class="col-md-8">
                    <img src="<?= base_url('assets/img/deluxe_room.jpg'); ?>" alt="" width="520px" height="250px">
                </div>
            ...
            <form class="row g-3 m-5" action="<?= base_url('/detail/deluxe-room/form-booking/save'); ?>" method="post">
                <?= csrf_field(); ?>
